...
import { ApplicationMainScreenProps, MainParamsList } from 'MyApp/@types/navigation'
...
export function hardwareBackPressHandle(viewName: MainParamsList | any, { navigation }: ApplicationMainScreenProps) {
  const backAction = () => {
