...
const Example = () => {
  ...
  return (
    ...
    >
      <View
        style={[Layout.fill, Layout.relative, Layout.fullWidth, Layout.justifyContentCenter, Layout.alignItemsCenter]}
      >
        <View
          style={[
            Layout.absolute,
        ...
        <View style={[Layout.row, Layout.justifyContentBetween, Layout.fullWidth, Gutters.smallTMargin]}>
          ...
          >
            {isFetching || isLoading ? (
              ...
              <Image source={Images.icons.send} style={{ tintColor: isDark ? '#A6A4F0' : '#44427D' }} />
            )}
          </TouchableOpacity>
